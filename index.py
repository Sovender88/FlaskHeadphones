...
def index():
    ...
    return render_template('car_user.html', username=session['username'], title='Наушники и не только - интернет магазин', cars=cars)
...
def add_car():
    ...
    return render_template("add_car.html", title='Добавление товара', form=form)
